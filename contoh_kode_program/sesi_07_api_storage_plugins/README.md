...
Selamat datang di repositori berkas kode mandiri **Sesi 07: Asynchronous REST API, Penyimpanan Lokal Offline Persisten, Hardware Plugins (GPS & Kamera), & TUGAS TUTORIAL 3** (Modul 8 & 9 BMP UT). Sesi ini memuat instrumen evaluasi tutorial resmi ketiga (Milestone 3) dengan bobot **20%** dari total nilai Tutorial Online (Tuton) di Universitas Terbuka.

Seluruh 18 berkas kode di bawah ini mematuhi **The Zero-Friction Courseware Framework**, dapat dijalankan langsung di peramban Google Chrome tanpa instalasi server lokal tambahan, serta dirancang khusus ramah laptop mahasiswa UT (RAM 4–8GB friendly).

---

## 🛠️ Panduan Alat Tempur Mahasiswa Awam (Memulai Pengujian)

Bagi mahasiswa yang baru pertama kali mempelajari integrasi API dan sensor hardware, Anda tidak perlu khawatir! Ikuti panduan praktis berikut:

1. **Google Chrome / Microsoft Edge (Peramban Web Utama):**
   * Cukup klik dua kali (*double-click*) berkas `.html` yang ingin diuji untuk membukanya langsung di peramban.
   * Tekan tombol keyboard `F12` untuk membuka **Chrome DevTools**.
   * Tekan kombinasi tombol `Ctrl + Shift + M` untuk mengaktifkan **Toggle Device Toolbar** (Mode Tampilan Layar Ponsel).
   * Gunakan tab **Network** untuk melihat lalu lintas data REST API, dan tab **Application > Storage** untuk melihat data fisik yang tersimpan di memori lokal.
2. **VS Code (Visual Studio Code):**
   * Digunakan untuk membuka folder proyek dan mengedit kode sumber template sesuai identitas diri Anda (NIM, Nama, UPBJJ).
3. **Ponsel Fisik Android / Browser Mobile:**
   * Berkas HTML ini dapat dikirimkan ke ponsel via WhatsApp Web / Google Drive, lalu dibuka langsung di Google Chrome Android untuk menguji sensor GPS dan kamera fisik secara nyata!
...
| `16` | `slide_16_rubrik_tugas_tutorial_3.html` | **Kalkulator Skor Interaktif & Rubrik Resmi TUGAS TUTORIAL 3 (Skala 0–100)** | [🌐 Buka Simulator](slide_16_rubrik_tugas_tutorial_3.html)<br>*(Panduan: [`.md`](slide_16_rubrik_tugas_tutorial_3.md))* |
...
1. Buka dan uji **Kalkulator Rubrik Interaktif** pada [`slide_16_rubrik_tugas_tutorial_3.html`](slide_16_rubrik_tugas_tutorial_3.html) (atau baca teks [`slide_16_rubrik_tugas_tutorial_3.md`](slide_16_rubrik_tugas_tutorial_3.md)) untuk memahami 4 pilar capaian penilaian.
2. Jalankan dan eksplorasi **Master Solusi Resmi** pada [`slide_17_solusi_tugas_3_study_tracker.html`](slide_17_solusi_tugas_3_study_tracker.html) langsung di peramban Google Chrome.
3. Modifikasi kode sesuai identitas Anda:
   * Masukkan nama lengkap, NIM 9 digit, dan UPBJJ-UT Anda.
   * Uji fitur pemanggilan live API cuaca sentra kampus UT daerah Anda.
